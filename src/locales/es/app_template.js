...
export default {
  ...
  APP_TEMPLATE_DESCRIPTION_ARTICLE: 'KubeSphere visualiza plantillas de aplicaciones y proporciona funciones de implementación y administración, lo que permite a los usuarios implementar aplicaciones rápidamente con un solo click en función de las plantillas de la aplicación.',
