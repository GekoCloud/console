...
export default {
  ...
  'Project Members Management': 'Gestión de miembros del proyecto',
  'Project Members View': 'Vista de miembros del proyecto',
  'Project Resources Management': 'Gestión de recursos del proyecto',
  'Project Roles': 'Roles del proyecto',
  'Project Roles Management': 'Gestión de Roles del Proyecto',
  'Project Roles View': 'Vista de roles del proyecto',
  ...
  'Role name exists': 'El nombre del rol existe',
  'Role Type': 'Tipo de papel',
  Roles: 'Roles',
  roles: 'roles',
  ...
  'Volume Snapshots Management': 'Gestión de instantáneas de volumen',
  'Volume Snapshots View': 'Vista de instantáneas de volumen',
  'Volumes Management': 'Gestión de volúmenes',
  'Volumes View': 'Vista de volúmenes',
  'Workspace App Repos Management':
    'Gestión de repositorios de aplicaciones de espacio de trabajo',
  'Workspace App Repos View':
    'Vista de repositorio de aplicaciones de espacio de trabajo',
  'Workspace App Templates Management':
    'Gestión de plantillas de aplicaciones de espacio de trabajo',
  'Workspace App Templates View':
    'Vista de plantillas de aplicación de espacio de trabajo',
  ...
  RULE_MONITORING: 'Gestión de monitoreo',
  ...
  RULE_REGISTRYS: 'Registro de imagen',
  RULE_PERSISTENTVOLUMECLAIMS: 'Gestión de volumen',
  RULE_STORAGECLASSES: 'Gestión de clase de almacenamiento',
  ...
  RULE_REGISTRIES: 'Registro de imagen',
  ...
  CLUSTER_SETTINGS_DESC:
    'Administre configuraciones de clúster y autorizaciones para espacios de trabajo y edite información de clúster',
  ROLE_CREATE_TIP_TITLE: 'Próximo paso',
  ROLE_CREATE_TIP_MESSAGE:
    'Debe editar la autorización, después de lo cual el rol se puedes crear correctamente.',
  NODES_VIEW_DESC: 'Ver información del nodo',
  NODES_MANAGEMENT_DESC:
    'Gestionar, habilitar y deshabilitar nodos; gestionar manchas',
  CRD_MANAGEMENT_DESC:
    'Administre, vea, modifique y elimine los CRD de clúster',
  COMPONENTS_MANAGEMENT_DESC: 'Administrar componentes del clúster',
  CLUSTERS_VIEW_DESC:
    'Ver todos los clústeres y recursos de clúster dentro de una plataforma',
  CLUSTERS_MANAGEMENT_DESC:
    'Crear y eliminar grupos; administrar recursos en todos los clústeres',
  ...
  WORKSPACES_MANAGEMENT_DESC:
    'Admite la gestión del espacio de trabajo, que incluye agregar / eliminar / editar espacios de trabajo; ver todos los espacios de trabajo en la plataforma',
  USERS_MANAGEMENT_DESC:
    'Admite la administración de cuentas, incluida la adición / eliminación / actualización de información de la cuenta',
  ROLES_MANAGEMENT_DESC:
    'Admite la gestión de roles de cuenta, que incluye agregar / eliminar / actualizar roles de cuenta',
  APP_TEMPLATES_VIEW_DESC: 'Ver plataforma App Store',
  APP_TEMPLATES_MANAGEMENT_DESC:
    'Administre App Store a nivel de plataforma y responsable de la gestión unificada del ciclo de vida de las aplicaciones nativas de la nube, incluido su lanzamiento, eliminación y revisión',
  PLATFORM_SETTINGS_MANAGEMENT_DESC:
    'Administre la configuración de la plataforma, como información de plataforma personalizada, configuración de recopilación de registros y notificación por correo electrónico',
  ACCOUNT_ROLE_DESC:
  ...
  PIPELINES_MANAGEMENT_DESC:
    'Administre la cartera de proyectos de DevOps, incluida la creación, edición y eliminación',
  PIPELINES_VIEW_DESC:
    'Vea la cartera de proyectos de DevOps y descargue artefactos',
  CREDENTIALS_MANAGEMENT_DESC:
    'Administre las credenciales del proyecto, incluida la creación, edición y eliminación.',
  CREDENTIALS_VIEW_DESC: 'Ver y usar credenciales',
  DEVOPS_ROLES_VIEW_DESC: 'Ver los roles del proyecto DevOps',
  ...
  DEVOPS_SETTINGS_DESC:
    'Administre la configuración del proyecto DevOps y edite la información del proyecto DevOps',
  ...
  CLUSTER_MONITORING_VIEW_DESC:
    'Ver los recursos físicos del clúster y los datos de monitoreo de los recursos de la aplicación.',
  ...
  CUSTOM_MONITORING_DESC:
    'Crear y administrar datos de monitoreo personalizados.',
  ALERTING_POLICIES_VIEW_DESC: 'Ver políticas de alertas',
  ALERTING_POLICIES_MANAGEMENT_DESC:
    'Crear / editar / eliminar políticas de alerta',
  ...
  PROJECT_SETTINGS_DESC:
    'Administre la configuración del proyecto y edite la información del proyecto, incluido el acceso a Internet, las políticas de red, la cuota de recursos y la recopilación y configuración del registro de disco',
  PROJECTS_MANAGEMENT_DESC:
    'Administre todos los proyectos en el espacio de trabajo, incluida la creación / edición / eliminación de proyectos',
  PROJECTS_CREATE_DESC:
    'Tener acceso para crear proyectos y el administrador del proyecto debe ser el creador',
  PROJECTS_VIEW_DESC: 'Ver todos los proyectos en el espacio de trabajo',
  DEVOPS_MANAGEMENT_DESC:
    'Administre todos los proyectos DevOps en el espacio de trabajo, incluida la creación / edición / eliminación de proyectos DevOps',
  DEVOPS_CREATE_DESC:
    'Tener acceso para crear proyectos DevOps y el administrador del proyecto DevOps debe ser el creador',
  DEVOPS_VIEW_DESC:
  ...
  WORKSPACE_APP_TEMPLATES_MANAGEMENT_DESC:
    'Cargar / editar / eliminar plantillas de aplicaciones de espacio de trabajo; liberar / eliminar aplicaciones para App Store en la plataforma',
  ROLE_PLATFORM_ADMIN:
    'Administrador de la plataforma que puedes administrar todos los recursos en la plataforma.',
  ...
  ROLE_CLUSTER_VIEWER:
    'Permite que cluster-viwer vea todos los recursos en el cluster.',
  ...
  ROLE_WORKSPACE_REGULAR:
    'Usuario habitual en el espacio de trabajo que no puedes crear espacios de nombres o proyectos DevOps.',
  ROLE_WORKSPACE_VIEWER:
    'Permite el acceso del espectador para ver todos los recursos en el espacio de trabajo.',
  ROLE_WORKSPACE_SELF_PROVISIONER:
    'Usuario habitual en el espacio de trabajo que puedes crear espacios de nombres y proyectos DevOps.',
  ROLE_PROJECT_ADMIN:
  ...
  ROLE_PROJECT_REGULAR:
    'El mantenedor del namespace que puedes administrar recursos que no sean usuarios y roles en el namespace.',
  ROLE_PROJECT_VIEWER:
    'Permite el acceso del espectador para ver todos los recursos en el namespace.',
  ROLE_PROJECT_OPERATOR:
    'El mantenedor del proyecto que puedes administrar recursos que no sean usuarios y roles en el proyecto.',
  ROLE_DEVOPS_ADMIN:
  ...
  ROLE_DEVOPS_REGULAR:
    'El mantenedor del namespace que puedes administrar recursos que no sean usuarios y roles en el proyecto DevOps.',
  ROLE_DEVOPS_VIEWER:
    'Permite el acceso del espectador para ver todos los recursos en el proyecto DevOps.',
}
