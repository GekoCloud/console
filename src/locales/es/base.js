...
export default {
  ...
  NOT_AVAILABLE: 'No disponible {resource}',
  NO_RESOURCE: 'En {resource}',
  RESOURCE_NOT_FOUND: 'Lo sentimos, el recurso no se encuentra.',
  CREATE_TIME: 'Creado {diff}',
  UPDATE_TIME: '{Diff} actualizado',
  MONTH_AGO: 'Hace {count, plural, = 1 {1 month} other {# months}}',
  MONTH_TIME: '{count, plural, = 1 {1 mes} other {# months}}',
  WEEK_AGO: 'Hace {count, plural, = 1 {1 semana} other {# weeks}}',
  WEEK_TIME: '{count, plural, = 1 {1 semana} other {# weeks}}',
  DAY_AGO: 'Hace {count, plural, = 1 {1 day} other {# days}}',
  DAY_TIME: '{count, plural, =1 {1 día} other {# days}}',
  HOUR_AGO: 'Hace {count, plural, = 1 {1 hour} other {# hours}}',
  HOUR_TIME: '{count, plural, = 1 {1 hora} other {# hours}}',
  MINUTE_AGO: 'Hace {count, plural, = 1 {1 minuto} otro {# minutes}}',
  MINUTE_TIME: '{count, plural, = 1 {1 minuto} otro {# minutes}}',
