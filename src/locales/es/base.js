...
export default {
  ...
  MONTH_AGO: 'Hace {count, plural, = 1 {1 mes} other {# meses}}',
  MONTH_TIME: '{count, plural, = 1 {1 mes} other {# meses}}',
  WEEK_AGO: 'Hace {count, plural, = 1 {1 semana} other {# semanas}}',
  WEEK_TIME: '{count, plural, = 1 {1 semana} other {# semanas}}',
  DAY_AGO: 'Hace {count, plural, = 1 {1 día} other {# días}}',
  DAY_TIME: '{count, plural, =1 {1 día} other {# días}}',
  HOUR_AGO: 'Hace {count, plural, = 1 {1 hora} other {# horas}}',
  HOUR_TIME: '{count, plural, = 1 {1 hora} other {# horas}}',
  MINUTE_AGO: 'Hace {count, plural, = 1 {1 minuto} other {# minutos}}',
