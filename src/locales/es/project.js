...
export default {
  ...
  Closed: 'Cerrado',
  'Container Resource Default Request': 'Solicitud predeterminada de recursos de contenedor',
  ...
  'Disk Log Collection of the project is about to be disabled.': 'La recopilación de registros de disco del proyecto está a punto de desactivarse.',
  'Edit Gateway': 'Editar puerta de enlace',
  'Edit Project': 'Editar proyecto',
  'Edit Project Quota': 'Editar cuota de proyecto',
  'Edit Resource Default Request': 'Editar solicitud predeterminada de recursos',
  'Empty value means no limit, CPU 1 Core = 1000m': 'El valor vacío significa que no hay límite, CPU 1 Core = 1000m',
  ...
  'How to invite other members to the current project?': '¿Cómo invitar a otros miembros al proyecto actual?',
  'How to set the project gateway?': '¿Cómo configurar la puerta de enlace del proyecto?',
  ...
  'Project name exists on host cluster': 'El nombre del proyecto existe en el clúster host',
  ...
  'Select a user of the workspace as the manager of the project.': 'Seleccione un usuario del espacio de trabajo como administrador del proyecto.',
  'Select Project Type': 'Seleccionar tipo de proyecto',
  'Select the cluster to create the project.': 'Seleccione el clúster para crear el proyecto.',
  Service: 'Servicio',
  ...
  Usage: 'Uso',
  Volume: 'Volumen',
  'You can limit the number of resources. Blank means no limit.': 'Puedes limitar la cantidad de recursos. En blanco significa que no hay límite.',
