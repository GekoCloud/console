...
export default {
  ...
  'Gateway Not Set': 'Gateway no establecido',
  ...
  'Multi-cluster Projects': 'Proyectos multi-cluster',
  ...
  'Project name exists on host cluster':
    'El nombre del proyecto existe en el clúster host',
  ...
  'requests.memory': 'solicitudes.memoria',
  ...
  statefulsets: 'conjuntos de estado',
  ...
  DEFAULT_RESOURCE_ALERT:
    'Cuando crea una carga de trabajo, esta configuración se utilizará de manera predeterminada si el límite de recursos y la solicitud de la carga de trabajo no están establecidos. Si no hay requisitos especiales, mantenga esta configuración predeterminada sin cambios.',
  QUOTA_EDIT_TIP:
