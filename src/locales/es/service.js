...
export default {
  ' has no corresponding workload.': 'no tiene carga de trabajo correspondiente.',
  ...
  'Commonly included tags in the current workloads': 'Etiquetas comúnmente incluidas en las cargas de trabajo actuales',
  'Container Port': 'Puerto de contenedores',
  'Create Service': 'Crear servicio',
  'Create service by specifying workloads': 'Crear servicio especificando cargas de trabajo',
  'Create service by Yaml': 'Crear servicio por Yaml',
  Creating: 'Creando',
  'Creation failed, please delete and try again': 'Creación fallida, borre e intente nuevamente',
  ...
  'No related resources found with current service(s)': 'No se encontraron recursos relacionados con los servicios actuales',
  ...
  'Please input selectors that have corresponding workloads': 'Ingrese los selectores que tienen las cargas de trabajo correspondientes',
  ...
  'Please select a workload': 'Por favor seleccione una carga de trabajo',
  'Please select Service': 'Por favor seleccione Servicio',
  Ports: 'Puertos',
  routes: 'rutas',
  Selector: 'Selector',
  selector: 'selector',
  ...
  'The maximum session sticky time is 10800s (3 hours).': 'El tiempo de permanencia máximo de la sesión es de 10800 s (3 horas).',
