...
export default {
  ...
  'Por favor introduce los selectores que tienen cargas de trabajo asociadas',
  ...
  'Sure to delete the service(s)?': '¿Seguro que quiere eliminar los servicios?',
