...
export default {
  ...
  'Please input ExternalName': 'Por favor ingrese ExternalName',
  'Please input ports': 'Por favor ingrese puertos',
  'Please input selectors that have corresponding workloads':
    'Ingrese los selectores que tienen las cargas de trabajo correspondientes',
  'Please input service name': 'Por favor ingrese el nombre del servicio',
  'Please input valid Selector': 'Por favor ingrese un selector válido',
