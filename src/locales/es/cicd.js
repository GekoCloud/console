...
export default {
  ...
  'Add nesting conditions': 'Agregar condiciones de anidamiento',
  'Add nesting steps': 'Agregar pasos de anidamiento',
  'Add Parallel Stage': 'Agregar etapa paralela',
  ...
  'Any repository containing Jenkinsfile will be built automatically.':
    'Cualquier repositorio que contenga Jenkinsfile se construirá automáticamente.',
  archiveArtifacts: 'archiveArtifacts',
  'Are you sure to close this pipeline Editor ?':
    '¿Estás seguro de cerrar este editor de canalizaciones?',
  ...
  Branch: 'Rama',
  branch: 'rama',
  'Branch Count': 'Cuenta de rama',
  'Branch Excluded': 'Rama excluida',
  'Branch Included': 'Rama incluida',
  'branch success': 'éxito de sucursal',
  ...
  'Chinese is not allowed in the pipeline configuration':
    'El chino no está permitido en la configuración de la tubería',
  'Clean when aborted': 'Limpio cuando abortado',
  'Clean Workspace': 'Espacio de trabajo limpio',
  'clone depth': 'profundidad de clon',
  ...
  'Days to Keep Builds': 'Días para mantener construcciones',
  ...
  dir: 'para ti',
  Discard: 'Descarte',
  'Discard old branch': 'Descartar rama vieja',
  'Discard Old Builds': 'Descartar construcciones antiguas',
  'Discover Branches': 'Descubre ramas',
  'Discover branches from repoitory':
    'Descubre sucursales desde el repositorio',
  'Discover PR form Forks': 'Descubre relaciones públicas de Forks',
  'Discover PR form Origin': 'Descubra el formulario PR Origen',
  'Discover pull requests from forks':
    'Descubra las solicitudes de extracción de las horquillas',
  'Discover pull requests from origin':
    'Descubra las solicitudes de extracción desde el origen',
  'Display All': 'Mostrar todo',
  'Docker Container Registry Credentials':
    'Docker Container Registry Credentials',
  'Docker Registry URL': 'URL del registro de Docker',
  ...
  'Edit Pipeline': 'Editar canalización',
  ...
  'Enter an expression': 'Introduce una expresión',
  'Enviroment name': 'Nombre del entorno',
  'Exclude branches that are also filed as PRs':
    'Excluir sucursales que también se presentan como RP',
  ...
  'instance failed to match at least one schema':
    'la instancia no pudo coincidir con al menos un esquema',
  'Internal nested conditions only need to satisfy one':
    'Las condiciones internas anidadas solo necesitan satisfacer una',
  ...
  'It specifies the default value of the field, allowing the user to save the typed actual value.':
    'Especifica el valor predeterminado del campo, lo que permite al usuario guardar el valor real escrito.',
  ...
  'Load the sonarqube configuration provided by Jenkins into the Pipeline.':
    'Cargue la configuración de sonarqube proporcionada por Jenkins en la tubería.',
  mail: 'correo',
  major: 'mayor',
  'Max # of old branches to keep':
    'Número máximo de ramas viejas para mantener',
  ...
  'No artifacts records': 'No hay registros de artefactos.',
  'No branches found': 'No se encontraron sucursales',
  'No commit records': 'Sin registros de compromiso',
  'No Concurrent Builds': 'No hay construcciones concurrentes',
  'No need': 'No hay necesidad',
  'no status': 'sin Estado',
  Normal: 'Normal',
  'Not Build': 'No construir',
  'Not fail build': 'No falla construir',
  'not run': 'no correr',
  'not support edit nested stage': 'no admite editar etapa anidada',
  ...
  'Old builds will be discarded after the build number exceeds the maximum amount.':
    'Las construcciones antiguas se descartarán después de que el número de compilación exceda la cantidad máxima.',
  'Only branches that are also filed as PRs':
    'Solo sucursales que también se presentan como RP',
  'Parametric Build': 'Construcción paramétrica',
  'Params Input': 'Entrada de parámetros',
  passphrase: 'frase de contraseña',
  'passphrase Variable': 'Frase de contraseña Variable',
  passphraseVariable: 'frase de contraseña',
  'Password Variable': 'Contraseña Variable',
  passwordVariable: 'contraseñaVariable',
  Pipeline: 'Tubería',
  'Pipeline clone timeout (in minutes)':
    'Tiempo de espera de clonación de tubería (en minutos)',
  'Pipeline config file not found':
    'Archivo de configuración de canalización no encontrado',
  'Pipeline Configuration': 'Configuración de tubería',
  'Pipeline Event Trigger': 'Desencadenador de eventos de canalización',
  'Pipeline initialization': 'Inicialización de tubería',
  'Pipeline List': 'Lista de tuberías',
  'Pipeline Run Logs': 'Registros de ejecución de tuberías',
  ...
  'Pull code by SVN': 'Tire del código por SVN',
  'Pull Strategy': 'Estrategia de extracción',
  ...
  Review: 'revisión',
  Run: 'correr',
  'Run Pipeline': 'Ejecutar tubería',
  'Save Artifact': 'Guardar artefacto',
  'Scan interval': 'Intervalo de escaneo',
  'Scan Logs Success': 'Escanear registros exitosos',
  'Scan repo success': 'Escanear el éxito del repositorio',
  'Scan Repo Trigger': 'Scan Repo Trigger',
  'Scan Reponsitory Logs': 'Escanear registros de repositorio',
  'Scan Repository': 'Repositorio de escaneo',
  Schedule: 'Calendario',
  'Scheduled Build': 'Build programado',
  SCM: 'SCM',
  'Script Path': 'Ruta de guion',
  ...
  'Specify the location of the Jenkinsfile in the source code repository':
    'Especifique la ubicación del archivo Jenkins en el repositorio de código fuente',
  ...
  'The environment variable entered before running the pipeline is match the current value.':
    'La variable de entorno ingresada antes de ejecutar la canalización coincide con el valor actual.',
  'The label on which to run the Pipeline or individual stage':
    'La etiqueta en la que se ejecuta la canalización o la etapa individual',
  'The name of the pipeline. Pipelines in the same project must have different names.':
    'El nombre de la tubería. Las tuberías en el mismo proyecto deben tener nombres diferentes.',
  ...
  'Timeout after no activity in logs for this block':
    'Tiempo de espera después de que no haya actividad en los registros de este bloque',
  timer: 'h',
  'Token / Password': 'Token / Contraseña',
  'Trigger a Remote Build (for example, using a script)':
    'Desencadenar una compilación remota (por ejemplo, usando un script)',
  'Trusted User': 'Usuario de confianza',
  Unnamed: 'Sin nombre',
  'url is invalid': 'url no es válida',
  'Use the following URL to remotely triggerworkbench the build':
    'Utilice la siguiente URL para activar remotamente workbench la compilación',
  ...
  'Username Variable': 'Nombre de usuario Variable',
  ...
  Webhook: 'Webhook',
  'When Create Pipeline': 'Cuando crear tubería',
  'When Delete Pipeline': 'Cuando eliminar tubería',
  ...
  PARAMS_DESC:
    'Los siguientes parámetros se generan en función de la configuración de la tubería o la sección de parámetros del archivo Jenkins, que se ingresan de acuerdo con los requisitos operativos.',
  ...
  PIPELINE_QUEUED_TITLE: 'La tubería se inicializará pronto',
