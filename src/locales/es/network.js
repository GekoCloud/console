...
export default {
  ...
  NETWORK_POLICY_DESC:
    'La configuración de la política de red permite el aislamiento de la red dentro del mismo clúster, lo que significa que se pueden configurar firewalls entre ciertas instancias (Pods).',
  ...
  NETWORK_POLICY_R_DESC2:
    'Se puedes permitir que los siguientes recursos accedan al proyecto actual (que coincida con cualquiera de las siguientes políticas)',
  ...
  NETWORK_POLICY_R2_DESC1:
    'Selecciona un rango específico de IP CIDR como origen de entrada o destino de salida.',
  NETWORK_POLICY_D_DESC:
    'Haga coincidir el tráfico de salida y el tráfico de entrada',
  NETWORK_POLICY_D_DESC2:
    'CIDR es una cadena que representa un bloque de IP válido, como &quot;192.168.1.1/24&quot;.',
  NETWORK_POLICY_D_OP1: 'Salida',
  NETWORK_POLICY_D_OP2: 'Ingreso',
  NETWORK_POLICY_CREATE_DESC:
    'La política de red está configurada para permitir el aislamiento de la red dentro del mismo clúster, es decir, la capacidad de construir un firewall entre ciertas instancias (pods).',
