...
export default {
  ...
  'No cluster with auditing module enabled': 'No hay clúster con módulo de auditoría habilitado',
  'No cluster with event query enabled': 'No hay clúster con consulta de eventos habilitada',
  'No cluster with logging module enabled': 'No hay clúster con módulo de registro habilitado',
  'Passwords must be at least 6 characters long': 'Las contraseñas deben tener al menos 6 caracteres.',
  'Please enter a filter to search for logs.': 'Ingrese un filtro para buscar registros.',
  ...
  topic: 'tema',
  'Trends in the total number of auditing logs in the last 12 hours': 'Tendencias en el número total de registros de auditoría en las últimas 12 horas',
  'Trends in the total number of events in the last 12 hours': 'Tendencias en el número total de eventos en las últimas 12 horas.',
  'Trends in the total number of logs in the last 12 hours': 'Tendencias en el número total de registros en las últimas 12 horas.',
