...
export default {
  ...
  'Click to select the artifact file to upload': 'Haga clic para seleccionar el archivo de artefactos para cargar',
  ...
  'Please set the access policy for the container.': 'Establezca la política de acceso para el contenedor.',
  'Please set the container name and computing resources.': 'Establezca el nombre del contenedor y los recursos informáticos.',
  'Published Time': 'Hora publicada',
  'Pull Command': 'Comando de extracción',
  'Rebuild Image': 'Reconstruir imagen',
  'Rebuilt successfully; the image status will be refreshed soon.': 'Reconstruido con éxito; el estado de la imagen se actualizará pronto.',
  ...
  sourceUrl: 'sourceUrl',
  SourceUrl: 'SourceUrl',
  'Specify a relative directory inside the application. (Default value /)': 'Especifique un directorio relativo dentro de la aplicación. (Valor por defecto /)',
  'Start Command': 'Comando de inicio',
  StartTime: 'Hora de inicio',
  'Target Image Repository': 'Repositorio de imágenes de destino',
  'The current code repository does not require a key.': 'El repositorio de código actual no requiere una clave.',
  'The file has not been uploaded.': 'El archivo no ha sido cargado.',
  'The health of the container will be checked regularly according to user needs.': 'La salud del contenedor se verificará periódicamente de acuerdo con las necesidades del usuario.',
