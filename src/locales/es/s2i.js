...
export default {
  'Add Enviroment Params': 'Agregar parámetros ambientales',
  'Artifact Type': 'Tipo de artefacto',
  'Authentication required': 'Autenticacion requerida',
  b2i: 'b2i',
  binary: 'binario',
  'Build Environment': 'Construir entorno',
  'Build Times': 'Tiempos de construcción',
  Builder: 'Constructor',
  'builder name': 'nombre del constructor',
  builderImage: 'builderImage',
  BuilderImage: 'BuilderImage',
  BuilderPullPolicy: 'BuilderPullPolicy',
  builderPullPolicy: 'builderPullPolicy',
  Building: 'edificio',
  'Building Image': 'Imagen del edificio',
  ...
  'Click to select the artifact file to upload':
    'Haga clic para seleccionar el archivo de artefactos para cargar',
  'Code Resource': 'Recurso de código',
  'Code URL': 'URL de código',
  'Container Settings': 'Configuración de contenedor',
  creationTimestamp: 'creationTimestamp',
  'Currently only supports git repo': 'Actualmente solo admite git repo',
  'Download Artifact': 'Descargar Artifact',
  'Environment Params': 'Parámetros ambientales',
  'exec: "git": executable file not found in $PATH':
    'exec: &quot;git&quot;: archivo ejecutable no encontrado en $ PATH',
  'File Size': 'Tamaño del archivo',
  'File Uploaded Successfully': 'Documento cargado exitosamente',
  'Image Artifacts': 'Artefactos de imagen',
  'Image Builder': 'Image Builder',
  'Image Builders': 'Constructores de imagen',
  'Image Building': 'Construcción de imágen',
  ...
  'New Image Tag': 'Nueva etiqueta de imagen',
  'New Tag': 'Nuevo día',
  'No Log Records': 'Sin registros',
  'Please set the access policy for the container.':
    'Establezca la política de acceso para el contenedor.',
  'Please set the container name and computing resources.':
    'Establezca el nombre del contenedor y los recursos informáticos.',
  'Published Time': 'Hora publicada',
  'Pull Command': 'Comando de extracción',
  'Rebuild Image': 'Reconstruir imagen',
  'Rebuilt successfully; the image status will be refreshed soon.':
    'Reconstruido con éxito; el estado de la imagen se actualizará pronto.',
  ...
  'Specify a relative directory inside the application. (Default value /)':
    'Especifique un directorio relativo dentro de la aplicación. (Valor por defecto /)',
  ...
  'The current code repository does not require a key.':
    'El repositorio de código actual no requiere una clave.',
  'The file has not been uploaded.': 'El archivo no ha sido cargado.',
  ...
  'Upload Percent': 'Porcentaje de carga',
  ...
  S2I_RELATIVE_PATH_DESC:
    'Dirección del repositorio de código fuente (actualmente admite git) y puedes asignar ramificaciones de código y rutas relativas en terminales de código fuente',
  START_COMMAND_DESC:
  ...
  RUN_COMMAND_DESC:
    'El comando de inicio del contenedor. Por defecto, se utilizará el comando de inicio para empaquetar. Utilice comas para separar múltiples comandos.',
  CONTAINER_PARAMS_DESC:
    'Los parámetros del comando de inicio del contenedor. Utilice comas para separar varios.',
  CONTAINER_ENVIROMENT_DESC: 'Agregue la variable de entorno del contenedor.',
  IMAGE_PULL_POLICY_DESC:
    'Por defecto, la imagen se extrae solo si aún no está presente localmente.',
  S2I_ENVIROMENT_DESC:
    'Los desarrolladores de aplicaciones pueden usar las siguientes variables de entorno para configurar el comportamiento en tiempo de ejecución de esta imagen; para configuraciones detalladas, vea <a href={link} target="_blank">Compilar plantillas</a> .',
  S2I_UPDATE_WORKLOAD:
    'Actualice la carga de trabajo después de construir con éxito',
  ...
  IMAGE_FROM_S2I_DESC:
    'Obtenga el código del repositorio de código existente y cree la imagen a través de Source to Image. El proceso de construir la imagen cada vez se realizará como un trabajo.',
  IMAGE_FROM_EXSIT:
    'Selecciona un contenedor de despliegue de imagen existente',
  IMAGE_FROM_EXSIT_DESC:
    'Extraiga una imagen de un repositorio de imágenes público o privado.',
  S2I_SECRET_DESC:
    'Si es un repositorio de código privado, elija la clave del repositorio de código.',
  ...
  S2I_IMAGENAME_DESC:
    'Nombre de la imagen y etiqueta, que por defecto es el nombre del proyecto del repositorio de código.',
  S2I_TARGET_IMAGE_REPONSTRY_DESC:
    'Debe seleccionar un repositorio de imágenes con permisos push para almacenar la imagen. De lo contrario, puedes <a href={link} target="_blank">crear una nueva credencial de repositorio de imágenes</a> .',
  ...
  B2I_DEFAULT_DESC:
    'Elija su artefacto para construir una imagen de contenedor',
  JAR_DESC:
    'Un archivo JAR es un formato de archivo de paquete que se usa comúnmente para agregar una gran cantidad de archivos de clase Java, metadatos relacionados y archivos de recursos (texto, imágenes, etc.) en un archivo.',
  WAR_DESC:
    'El archivo WAR es un archivo utilizado para distribuir una colección de archivos JAR, páginas JavaServer, Java Servlets, clases Java, archivos XML, bibliotecas de etiquetas, páginas web estáticas (HTML y archivos relacionados) y otros recursos que juntos constituyen una aplicación web.',
  BINARY_DESC: '',
