...
export default {
  ...
  'Allocate all traffic proportionally to grayscale release components': 'Asigne todo el tráfico proporcionalmente a los componentes de liberación en escala de grises',
  'Blue-green Deployment': 'Despliegue azul-verde',
  'Canary Release': 'Lanzamiento Canario',
  'Cookie Content': 'Contenido de cookies',
  'Create Grayscale Release Job': 'Crear trabajo de lanzamiento en escala de grises',
  'Create Job': 'Crear trabajo',
  'Custom Header': 'Cabecera personalizada',
  'Deploy sample application': 'Implementar aplicación de muestra',
  'Deploy Sample Application': 'Implementar aplicación de muestra',
  'Edit Grayscale Release Job': 'Editar trabajo de lanzamiento en escala de grises',
  ...
  'Grayscale Release Component': 'Componente de lanzamiento en escala de grises',
  'Grayscale Release Components': 'Componentes de lanzamiento en escala de grises',
  ...
  'Grayscale release version access rule': 'Regla de acceso a la versión de lanzamiento en escala de grises',
  'Grayscale Release Version Number': 'Número de versión de lanzamiento en escala de grises',
  'Has taken over all traffic': 'Se ha apoderado de todo el tráfico',
  'Introduce traffic that meets the following rules into grayscale version': 'Introducir tráfico que cumpla con las siguientes reglas en la versión en escala de grises',
  ...
  'Please input grayscale release version': 'Ingrese la versión de lanzamiento en escala de grises',
  'Please select a grayscale release component': 'Seleccione un componente de lanzamiento en escala de grises',
  'Policy Config': 'Configuración de política',
  'Port protocol is not HTTP, cannot publish policy by request content': 'El protocolo del puerto no es HTTP, no puede publicar la política por el contenido de la solicitud',
  ...
  'The current version is not online, you can let this version take over all traffic and bring it online.': 'La versión actual no está en línea, puede dejar que esta versión se haga cargo de todo el tráfico y ponerlo en línea.',
  traffic: 'tráfico',
  'Traffic comes from the following operating systems': 'El tráfico proviene de los siguientes sistemas operativos',
  ...
  'Unfinished grayscale release jobs exist': 'Existen trabajos de liberación en escala de grises sin terminar',
  ...
  NO_SERVICE_MESH_TIP: 'Las aplicaciones que no están habilitadas para el gobierno de aplicaciones no se pueden publicar en escala de grises.',
