...
export default {
  ...
  'Authorize the cluster to workspace': 'Autorizar el clúster al espacio de trabajo',
  ...
  'Please input the kubesphere api server address of the cluster': 'Ingrese la dirección del servidor de la API de Kubesphere del clúster',
  'Please select or input a provider': 'Por favor seleccione o ingrese un proveedor',
  'Please select or input a tag': 'Por favor seleccione o ingrese una etiqueta',
  'Scheduler Scheduling Times': 'Horarios de programación',
  'Scheduling Failed Pods': 'Programar vainas fallidas',
  ...
  SELECT_CLUSTERS_DESC: 'Seleccione el clúster disponible en el espacio de trabajo.',
  CLUSTER_SETTINGS_DESC: 'Definir información de configuración del clúster',
  CLUSTER_TAG: 'Etiqueta',
  CLUSTER_TAG_DESC: 'Para indicar para qué se utiliza el clúster, como un entorno de producción, un entorno de prueba o un entorno de demostración',
  ...
  CLUSTER_WAITING_JOIN_DESC: 'Actualmente no hay nodos disponibles. El clúster no se puede usar. Puede agregar el siguiente archivo de configuración para habilitar el clúster.',
  CLUSTER_AGENT_TIP_1: 'Cree un archivo llamado agent.yaml en el clúster de destino a través de SSH',
  CLUSTER_AGENT_TIP_1_DESC: 'Por ejemplo, <span class="code">agent.yaml</span> .',
  CLUSTER_AGENT_TIP_2: 'Copie el siguiente archivo de configuración en agent.yaml',
  CLUSTER_AGENT_TIP_2_DESC: 'El archivo del agente puede conectar el clúster de destino a la plataforma.',
  CLUSTER_AGENT_TIP_3: 'Ejecutar en la línea de comando <span class="code">kubectl create -f agent.yaml</span>',
  ...
  CLUSTER_BASE_INFO_DESC: 'Este módulo resume la información básica del clúster actual.',
  ...
  CLUSTER_API_SERVER_DESC: 'Debe ingresar la dirección del servidor API de KubeSphere para agregarla al clúster',
  ...
  UNBIND_CLUSTER_DESC: 'Una vez que el clúster no está vinculado, KubeSphere no podrá administrar el clúster y los recursos de Kubernetes dentro del clúster no se eliminarán.',
  ...
  CLUSTER_VISIBILITY_Q1: '¿Cómo autorizar clústeres a espacios de trabajo específicos?',
  CLUSTER_VISIBILITY_A1: 'Puede autorizar el clúster a diferentes espacios de trabajo haciendo clic en Editar visibilidad.',
