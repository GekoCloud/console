...
export default {
  ...
  'Authorize the cluster to workspace':
    'Autorizar el clúster al espacio de trabajo',
  ...
  'Cluster initialization failed': 'La inicialización del clúster falló',
  'Cluster List': 'Lista de clúster',
  'Cluster Management': 'Manejo de clúster',
  ...
  'Copy successfully': 'Copia exitosamente',
  ...
  'Enter the project': 'Entra al proyecto',
  'Go back': 'Regresa',
  'Host Cluster': 'Clúster de host',
  'Host Clusters': 'Clusters de host',
  Import: 'Importar',
  ...
  'Kubernetes Version': 'Versión Kubernetes',
  'Member Cluster': 'Grupo de miembros',
  'Member Clusters': 'Grupos de miembros',
  ...
  Unbind: 'Desatar',
  'Unbind Cluster': 'Desenlazar clúster',
  'User Projects': 'Proyectos de usuario',
  Validating: 'Validar',
  'Validation failed': 'Validación fallida',
  'Waiting for the cluster to join': 'Esperando a que el clúster se una',
  ...
  CLUSTER_WAITING_JOIN_DESC:
    'Actualmente no hay nodos disponibles. El clúster no se puedes usar. Puedes agregar el siguiente archivo de configuración para habilitar el clúster.',
  CLUSTER_AGENT_TIP_1:
