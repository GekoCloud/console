...
export default {
  ...
  'local disk space utilization rate': 'ratio de utilización de espacio del disco local',
  major: 'mayor',
  Major: 'Mayor',
  ...
  'memory utilisation (including cache)':
    'uso de memoria (incluyendo caché)',
  ...
  'pod abnormal ratio': 'Ratio anormal de pod',
  ...
  triggered: 'disparados',
  'triggered alerting messages': 'mensaje de alerta disparados',
  ...
  ALERT_POLICY_SETTING_DESC: 
    'Puede encontrar la condición anormal del recurso en el tiempo estableciendo las reglas de alerta',
  ...
  'ALERTING-POLICY_MONITORING-TARGET_DESC': 
    'Seleccione el objetivo de monitorización de la política de alertas.',
  ...
  PERIOD_OPTIONS: '{value, plural, = 1 {1 minute / period} otro {# minutes / period}}',
  ...
  NOTIFY_LIST_INPUT_PLACEHOLDER: 'Introduzca la dirección de correo electrónico del miembro que debe ser notificado.',
  ...
  HOW_TO_SUPRESS_AN_ALARM_A: 
    'Cada política de alerta se puede establecer en diferentes niveles, y cada nivel corresponde a un período de alerta y período de repetición diferente.',
  PROJECT_MONITOR_TARGET_TIPS: 
    'Una alerta puede especificar únicamente una política de tipo de recurso',
  RULE_NAME_DESC: 
    'El nombre de la regla puede estar compuesto de cualquier carácter para ayudarle a distinguir mejor los recursos.',
}
