...
export default {
  ...
  'Please input a monitoring target to find': 'Por favor, introduce un objetivo de monitorización a encontrar',
  ...
  ALERT_MESSAGE_DESC: 'Los mensajes de alerta se generan en función de las métricas de monitorización y de las políticas de alerta de carga de trabajo en el proyecto actual. Pueden ayudar a los usuarios a detectar problemas y responder a tiempo.',
  ...
  ALERT_POLICY_SETTING_TITLE: 'La política de alerta pertinente no se aplica temporalmente',
  ALERT_POLICY_SETTING_DESC: 'Puede encontrar la condición anormal del recurso en el tiempo estableciendo las reglas de alerta',
  ALERTING_POLICY_CREATE_DESC: 'Puede encontrar la condición anormal del recurso en el tiempo estableciendo las reglas de alerta',
  'ALERTING-POLICY_BASEINFO_DESC': 'Establecer información básica sobre la política de alerta',
  'ALERTING-POLICY_MONITORING-TARGET_DESC': 'Seleccione el objetivo de monitorización de la política de alertas.',
  ...
  REPEAT_CUSTOM_DESC: 'Los mensajes de alerta se enviarán repetidamente a intervalos específicos según su gravedad. Se adopará la política predeterminada a menos que realice algún cambio en ella.',
  ...
  REPEAT_RULE_EXP_TIP: 'Notificación de incremento de índice periódico: cuando la duración de la alerta alcanza 1, 2, 4, 8, 16, 32 ... veces el intervalo de estadísticas de alerta, se envía una notificación de alerta.',
  ...
  REQUESTS_FOR_TRIGGER_AN_ALARM_Q: '¿Pre-requisitos para activar un mensaje de alerta?',
  REQUESTS_FOR_TRIGGER_AN_ALARM_A: 'Debe establecer una política de alerta para un recurso. Cuando un determinado indicador de un recurso alcanza el umbral de la política de alerta, el mensaje se activa y envía.',
  REQUESTS_FOR_PUSH_AN_ALARM_Q: '¿Pre-requisitos para un mensaje push de política de alerta?',
  REQUESTS_FOR_PUSH_AN_ALARM_A: 'Es necesario que el administrador de la plataforma configure el servidor de correo.',
  ...
  PROJECT_MONITOR_TARGET_TIPS: 'Una alerta puede especificar únicamente una política de tipo de recurso',
  RULE_NAME_DESC: 'El nombre de la regla puede estar compuesto de cualquier carácter para ayudarle a distinguir mejor los recursos.',
