...
export default {
  ...
  'App store deployment': 'Implementación de la tienda de aplicaciones',
  ...
  'Temporarily unable to use tracing':
    'No se puede usar el rastreo temporalmente',
  'Temporarily unable to use traffic management':
    'No se puede utilizar temporalmente la gestión del tráfico.',
  ...
  LB_ALG_DESC:
    'Admite algoritmos de equilibrio de carga estándar </br> ROUND_ROBIN ： Sondeo, el algoritmo de equilibrio de carga predeterminado. </br> LEAST_CONN: seleccione aleatoriamente dos hosts sanos y luego seleccione un host con menos enlaces de los dos hosts seleccionados. </br> ALEATORIO: Elija uno al azar de todos los hosts sanos.',
  ...
  CLUSTER_ALIAS_DESC:
    'El alias puede estar compuesto de cualquier carácter para ayudarlo a distinguir mejor los recursos y admitir nombres chinos.',
  COMPONENT_VERSION_DESC:
    'Para la aplicación de la gobernanza para distinguir entre componentes. Solo puede contener letras minúsculas y números. La longitud máxima de caracteres se establece en 16.',
  APP_WORKLOAD_TYPE_DESC:
    'Admite servicios sin estado (implementación) y servicios con estado (StatefulSet)',
  ...
  POD_ISOLATION_RATIO_DESC:
    '% Máximo de Pod para el servicio ascendente que se puede expulsar. Utiliza redondeo ascendente, cuando se establece en 13%, aislará hasta 2 instancias si existen 10 instancias.',
  ...
  COMPOSING_APP_DESC:
    'Puede publicar servicios para crear aplicaciones a través de la orquestación de recursos (compatible con Application Governance).',
  APP_TEMPLATES_MODAL_DESC:
    'La plantilla de la aplicación proviene del espacio de trabajo y las plantillas de la aplicación Helm de terceros. Admite la implementación con un clic y se puede visualizar en KubeSphere para mostrar y proporcionar implementaciones y funciones de administración.',
  TIP_APP_TYPE:
  ...
  APPLICATION_SERVICE_DESC:
    'Puede configurar diferentes componentes de servicio según el tipo de servicio en una aplicación. Los servicios con estado y sin estado son compatibles.',
}
